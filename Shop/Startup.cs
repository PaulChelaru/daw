...
using Shop.Seed;
using Shop.Services.UserServices;
using System;
...
namespace Shop
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ShopContext>(options => options.UseSqlServer("Data Source=PCHELARU-L;Initial Catalog=Shop;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False"));
